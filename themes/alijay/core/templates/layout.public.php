 ...
 *
 * Theme override (alijay): adds Icon Industries developer credit. When upgrading Nextcloud,
 * diff against core/templates/layout.public.php and merge upstream changes.
 */
?>
<!DOCTYPE html>
...
<body id="<?php p($_['bodyid']);?>" <?php foreach ($_['enabledThemes'] as $themeId) {
	...
	<footer class="guest-box">
		...
		<?php } ?>
		<p class="info alijay-dev-credit" translate="no">Engineered by Icon Industries</p>
	</footer>
	<?php } ?>
